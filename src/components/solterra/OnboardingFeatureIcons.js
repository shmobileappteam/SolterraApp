...
export function OnboardingFeatureIcon({ name }) {
  switch (name) {
    case 'space':
      return (
    ...
    case 'track':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Circle cx="12" cy="12" r="3" {...stroke(1.5)} />
          <Path
    ...
    case 'check':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Path d="M20 6L9 17l-5-5" {...stroke(2.2)} />
        </Svg>
      );
    case 'house':
      return (
    ...
    case 'wallet':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Path d="M4 7h14a2 2 0 012 2v8H6a2 2 0 01-2-2V7z" {...stroke()} />
          <Path d="M4 7V6a2 2 0 012-2h10v3" {...stroke()} />
    ...
    case 'person':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          ...
          <Path d="M6 19c1.2-3 3.4-4.5 6-4.5s4.8 1.5 6 4.5" {...stroke()} />
        </Svg>
      );
    case 'phone':
      return (
      ...
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Path
            ...
            {...stroke(1.5)}
          />
          <Path d="M7 5.5L5 7.5l2 2" {...stroke(1.5)} />
          <Path
            d="M17 18.5h-5.5a2.5 2.5 0 01-2.5-2.5V13"
            {...stroke(1.5)}
          />
          <Path d="M17 18.5l2-2-2-2" {...stroke(1.5)} />
          <Path
    ...
    case 'weather':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Circle cx="8.5" cy="9" r="2.8" {...stroke(1.5)} />
          <Path
    ...
    case 'clipboardCheck':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          ...
          />
          <Path d="M9 4h6v4H9V4z" {...stroke()} />
          <Path d="M9.5 13.5l1.8 1.8L15 11.5" {...stroke(1.6)} />
        </Svg>
      );
    case 'group':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Circle cx="9" cy="8" r="2.5" {...stroke(1.5)} />
          <Circle cx="16" cy="9" r="2" {...stroke(1.5)} />
          <Path d="M5 18c.8-2.5 2.4-3.8 4-3.8s3.2 1.3 4 3.8" {...stroke(1.5)} />
          <Path d="M13.5 17.5c.5-1.5 1.5-2.5 2.5-2.5s2 1 2.5 2.5" {...stroke(1.5)} />
        </Svg>
      );
    case 'heart':
      return (
    ...
    case 'harvest':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Path d="M6 10h12v9H6V10z" {...stroke()} />
          <Path d="M9 10V8a3 3 0 016 0v2" {...stroke()} />
        </Svg>
      );
    case 'sprout':
      return (
    ...
    case 'award':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Circle cx="12" cy="9" r="4.5" {...stroke()} />
          <Path d="M8.5 14.5L7 20l5-2.5L17 20l-1.5-5.5" {...stroke(1.5)} />
          <Path d="M10.5 8.5l1.5 1.5 2.5-2.5" {...stroke(1.5)} />
        </Svg>
      );
    case 'budget':
      return (
      ...
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Path
            ...
            {...stroke(1.5)}
          />
          <Path d="M9.5 12.5l1.8 1.8L15 10.5" {...stroke(1.6)} />
        </Svg>
      );
    case 'beginner':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Path d="M6 10h12v9H6V10z" {...stroke()} />
          <Path d="M9 10V8a3 3 0 016 0v2" {...stroke()} />
          <Path d="M9.5 14.5c.8 1.2 2 1.8 2.5 1.8s1.7-.6 2.5-1.8" {...stroke(1.4)} />
        </Svg>
      );
    case 'experience':
      return (
      ...
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Path
            ...
            {...stroke()}
          />
          <Path d="M12 8c0-2.2 1.2-4 3-4.5" {...stroke(1.4)} />
        </Svg>
      );
    case 'bee':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Path
            ...
            {...stroke()}
          />
          <Path d="M12 8.5V6M9.5 9l-1.5-1M14.5 9l1.5-1" {...stroke(1.4)} />
    ...
    case 'fence':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Path d="M5 8v11M9 8v11M15 8v11M19 8v11" {...stroke(1.5)} />
          <Path d="M4 8h16M4 12h16M4 16h16" {...stroke(1.4)} />
        </Svg>
      );
    case 'soil':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Path d="M5 16c2-3 4-4 7-4s5 1 7 4" {...stroke()} />
          <Path d="M8 12c.5-2 2-3 4-3s3.5 1 4 3" {...stroke(1.4)} />
    ...
    case 'zone':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          ...
          <Circle cx="12" cy="12" r="2" {...stroke(1.4)} />
          <Path d="M12 5v2M12 17v2M5 12h2M17 12h2" {...stroke(1.3)} />
        </Svg>
      );
    case 'magnify':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          ...
          <Path d="M15 15l4.5 4.5" {...stroke(1.8)} />
        </Svg>
      );
    case 'droplet':
      return (
    ...
    case 'timeClock':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Circle cx="12" cy="12" r="7.5" {...stroke()} />
          <Path d="M12 8v4.5l3 2" {...stroke(1.5)} />
        </Svg>
      );
    case 'projects':
      return (
    ...
    case 'gallery':
      return (
        <Svg width={ICON} height={ICON} viewBox="0 0 24 24" fill="none">
          <Path d="M4 7h16v12H4V7z" {...stroke()} />
          <Circle cx="9" cy="11" r="1.5" {...stroke(1.4)} />
          <Path d="M4 16l4.5-4 3 2.5L16 10l4 4" {...stroke(1.4)} />
        </Svg>
      );
    case 'puzzle':
      return (
