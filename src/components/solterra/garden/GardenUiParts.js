...
export const TabLeaf = ({ active }) => (
  <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
    <Path
      ...
      fill="none"
    />
    <Path d="M11 20v-8" stroke={active ? G.forest : G.muted} strokeWidth={active ? 2 : 1.5} />
  </Svg>
);

export const TabGrid = ({ active }) => (
  <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
    <Rect x="3" y="3" width="7" height="7" rx="1" stroke={active ? G.forest : G.muted} strokeWidth={active ? 2 : 1.5} />
    <Rect x="14" y="3" width="7" height="7" rx="1" stroke={active ? G.forest : G.muted} strokeWidth={active ? 2 : 1.5} />
    <Rect x="3" y="14" width="7" height="7" rx="1" stroke={active ? G.forest : G.muted} strokeWidth={active ? 2 : 1.5} />
    <Rect x="14" y="14" width="7" height="7" rx="1" stroke={active ? G.forest : G.muted} strokeWidth={active ? 2 : 1.5} />
  </Svg>
);

export const TabHammer = ({ active }) => (
  <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
    <Path
...
export const TabStethoscope = ({ active }) => (
  <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
    <Path
      ...
      strokeLinecap="round"
    />
    <Circle cx="18" cy="16" r="2" stroke={active ? G.forest : G.muted} strokeWidth={active ? 2 : 1.5} />
  </Svg>
);
...
export const PlanOverlayFab = ({ children }) => (
  <View style={circleBtnStyles.fab}>{children}</View>
);
